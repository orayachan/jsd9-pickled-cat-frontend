...
export function AddProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.details || error.message || 'ไม่สามารถเพิ่มสินค้าได้';
  ...
  return (
    <div className='space-y-4'>
      ...
      <form className='grid grid-cols-2 gap-6' onSubmit={handleSubmit}>
        ...
        {/* รายละเอียดสินค้า */}
        <div className='flex flex-col space-y-2'>
          <label className='font-semibold'>รายละเอียดสินค้า (20-300 ตัวอักษร)</label>
          <textarea
            name="description"
        ...
        <div className='col-span-2'>
          <button
            ...
            className='bg-primary rounded-lg px-4 py-2 font-bold text-white hover:cursor-pointer hover:text-green-500 disabled:opacity-50 disabled:cursor-not-allowed'
          >
