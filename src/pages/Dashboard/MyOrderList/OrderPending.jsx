    ...
    <section className="flex flex-col gap-4">
      <div className="flex flex-col border rounded-lg p-4 shadow-sm bg-white">
        <div className="flex flex-row mb-2 mx-2 justify-between">
          ...
          <p className="text-lg font-bold text-yellow-500">กำลังจัดเตรียม</p>
        </div>
        ...
        <div className="flex flex-row mb-2 mx-2 justify-between">
          <div className="flex flex-row gap-4">
            <Button className="p-4 bg-white border text-black text-lg hover:bg-secondary-100">ยกเลิกคำสั่งซื้อ</Button>
          </div>
          <p className="text-lg mt-auto">รวมทั้งสิ้น ( 3 สินค้า ) : <strong>฿ 750</strong></p>
        </div>
      </div>
    </section>
  );
