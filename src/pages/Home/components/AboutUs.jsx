...
export function AboutUs() {
  return (
    ...
    <section id='contact' class='mx-4 mb-16 bg-white'>
      <div class='relative mx-auto flex max-w-screen-xl flex-col justify-center'>
        <div className='flex flex-col'>
          ...
          <div class='m-4 flex flex-col justify-between gap-8 lg:flex-row'>
            <div class='border-primary-500 max-w-220 min-w-70 flex-[1] rounded-3xl border-2'>
            ...
            <div class='border-primary-500 max-w-220 min-w-70 flex-[1] rounded-3xl border-2'>
              <div class='m-8 flex flex-col justify-center gap-2'>
                ...
                <h3 class='text-primary-800'>contact@pickledcat.com</h3>
              </div>
            </div>
            ...
            <div class='border-primary-500 max-w-220 min-w-70 flex-[1] rounded-3xl border-2'>
              <div class='m-8 flex flex-col justify-center gap-2'>
                ...
                <h3 class='text-primary-800'>(+66) 99 999 9999</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* <!-- Map --> */}
        <div class='bg-secondary-50 mx-4 my-8 flex max-w-220 justify-center rounded-3xl p-4 lg:max-w-1280 lg:min-w-225'>
          <iframe
